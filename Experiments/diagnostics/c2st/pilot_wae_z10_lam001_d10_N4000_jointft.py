...
output_stem = (
    f"rl_c2st_wae_imq_HDGM_d10_power_{args.shard_id}"
)
...
def build_payload(records):
    ...
    return {
        ...
        "phase2": {
            "model": (
                "jointly fine-tuned z=10 WAE encoder followed by trainable 10->30->30->30 nonlinear C2ST feature head"
            ),
        ...
        "note": (
            ...
            "phase 2 through a jointly fine-tuned z=10 encoder and trainable nonlinear 30-D head, with C2ST LR=0.005. "
...
class JointFTZ10MLPHead(nn.Module):
    ...
    def __init__(self, encoder):
        ...
        # Diagnostic: allow the Phase-1 WAE encoder to adapt jointly
        # during supervised C2ST training.
...
for n in n_list:
    ...
    for kk in progress:
        ...
        phase2_model = JointFTZ10MLPHead(encoder).to(device, dtype)
