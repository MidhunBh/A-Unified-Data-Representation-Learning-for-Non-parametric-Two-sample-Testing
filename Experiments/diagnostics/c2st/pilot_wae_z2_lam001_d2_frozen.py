...
# ============================================================
# PILOT FROZEN: RL-C2ST(WAE-MMD/IMQ) — HDGM d=2, latent z=2, lambda=0.01
#
...
for n in n_list:
    ...
    for kk in progress:
        ...
        # ----------------------------------------------------
        # DIAGNOSTIC CONDITION: FROZEN WAE REPRESENTATION
        #
        # Phase 1 is identical to the successful z=2,
        # lambda=0.01 calibration/pilot.
        #
        # The ONLY experimental change relative to the previous
        # joint pilot is that Phase 2 cannot modify the WAE
        # encoder. C2ST therefore learns only its classifier
        # weights on top of the fixed WAE representation.
        # ----------------------------------------------------
