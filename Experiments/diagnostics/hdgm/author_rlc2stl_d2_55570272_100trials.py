...
n_list = [125, 250]  # paper N = [1000, 2000]
#n_list = [250, 375, 500]
# n_list = [7.5, 10, 12.5]
...
with open('result/author55570272_rlc2st_d2_100trials.pkl', 'wb') as file:
...
meta = {
    ...
    "note": (
        "100-trial confirmation reconstructing the historical d=2 path associated "
        "with author SLURM job 55570272. C2ST-S is additionally evaluated "
        "from the same fitted model to investigate the paper/log statistic-label ambiguity."
    ),
...
with open("result/author55570272_rlc2st_d2_100trials.json", "w") as f:
    json.dump(meta, f, indent=2)

print("Saved historical 55570272 pilot:")
print("  result/author55570272_rlc2st_d2_100trials.pkl")
print("  result/author55570272_rlc2st_d2_100trials.json")
