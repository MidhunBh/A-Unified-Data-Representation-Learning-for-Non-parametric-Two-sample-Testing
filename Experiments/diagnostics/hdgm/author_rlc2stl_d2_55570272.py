...
N_TRAIL = 30  # diagnostic pilot; author full run used 100
...
with open('result/author55570272_rlc2st_d2_pilot.pkl', 'wb') as file:
...
meta = {
    ...
    "note": (
        "30-trial pilot reconstructing the historical d=2 path associated "
...
with open("result/author55570272_rlc2st_d2_pilot.json", "w") as f:
    json.dump(meta, f, indent=2)

print("Saved historical 55570272 pilot:")
print("  result/author55570272_rlc2st_d2_pilot.pkl")
print("  result/author55570272_rlc2st_d2_pilot.json")
