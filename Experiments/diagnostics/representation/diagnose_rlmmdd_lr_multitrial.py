...
alpha = 0.05
n = 250  # N=2000, matches existing 100-trial anchor
N_TRAIL = 15
N_TEST = 30
N_PER = 100

print("Anchor (already have, not rerunning): lr_mmd=0.00005 (100 trials) -> power=0.269\n")

for lr_mmd in [0.0005, 0.000005]:
