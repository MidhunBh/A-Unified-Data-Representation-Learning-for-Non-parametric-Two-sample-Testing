...
alpha = 0.05
n = 250  # N=2000 -- matches an N where we already have real 100-trial ground truth (lambda=0.1: 0.04/0.06)
N_TRAIL = 15
N_TEST = 30
N_PER = 100
AE_EPOCHS = 2000
...
for lambda_target in [0.05, 0.02]:
    ...
    print(f"(compare: lambda=0.1 at this same N, full 100-trial: power_S=0.04 power_L=0.06)")
