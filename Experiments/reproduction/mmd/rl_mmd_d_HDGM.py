...
with open("result/rl_mmd_d_HDGM_d2_power.pkl", "wb") as file:
...
meta = {
    ...
    "epochs_ae" : 2000,
    "lr_mmd"  : 0.00005,
    "note"    : "RL-TST applied to MMD-D — AE Phase 1 frozen, deep kernel Phase 2/3 on IRs. d=2 for Fig4a.",
    "result"  : [float(np.mean(r)) for r in mmd_baseline_result],
    "ts"      : time.strftime("%Y-%m-%d %H:%M"),
}
with open("result/rl_mmd_d_HDGM_d2_power.json", "w") as f:
    json.dump(meta, f, indent=2)
print("logged to result/rl_mmd_d_HDGM_d2_power.json")