...
for n in n_list:
    ...
    for kk in tqdm.trange(100):
        ...
        print("Type-I error of MMD-D: ", H_MMD.sum() / N_TEST_F)
...
with open("result/mmd_d_HDGM_d2_type1.pkl", "wb") as file:
...
with open("result/mmd_d_HDGM_d2_type1.json", "w") as f:
    json.dump(meta, f, indent=2)
print("logged to result/mmd_d_HDGM_d2_type1.json")